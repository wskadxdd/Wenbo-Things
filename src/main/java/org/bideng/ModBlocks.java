...
public class ModBlocks {
    public static final Block CLASSROOM_TABLE = register("classroom_table", ClassroomTable::new, ClassroomTable.Settings.create().strength(0.5f));
    public static final Block CLASSROOM_CHAIR = register("classroom_chair", ClassroomChair::new, ClassroomChair.Settings.create().strength(0.5f));
